...
$selectedClass = $data['selectedClass'];   // Use array notation
    ...
    $sql = "UPDATE student_info SET section = ? WHERE student_id = ?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "si", $selectedClass, $studentId);
